...
branah.keyboard.prototype.drawKeyboard=function() {
    ...
    if(b) {
        $("#branah-caps-lock").addClass("branah-recessed"+(this.caps?"": "-hover"))
    }
}
...
branah.keyboard.prototype.wireEvents=function() {
    ...
    $("#branah-keyboard").delegate("button", "mousedown", function(b) {
        ...
        a.interval=setInterval(function() {
            ...
            if(a.counter>5) {
                switch(c) {
                    case"branah-backspace": a.onBackspace();
                    break;
    ...
    $("#branah-keyboard").delegate("button", "click", function(b) {
        var c=this.id;
        switch(c) {
            case"branah-left-shift": case"branah-right-shift": a.onShift();
            break;
            case"branah-left-alt": case"branah-right-alt": a.onCtrl();
            a.onAlt();
            break;
            case"branah-left-ctrl": case"branah-right-ctrl": a.onAlt();
            a.onCtrl();
            break;
            case"branah-escape": a.onEsc();
            break;
            case"branah-caps-lock": a.onCapsLock();
            break;
            case"branah-backspace": a.onBackspace();
            break;
            case"branah-enter": a.onEnter();
            break;
            case"branah-space": a.onSpace();
            break;
            default:if(c.search("branah-k([0-9])|([1-3][0-9])|(4[0-7])")!=-1) {
                a.onKey(c.substr(7));
                a.shift=false;
...
;
branah.util.indexOf=function(a, d) {
    var c=a.length;
    for(var b=0;
    b<c;
    b++) {
...
;
branah.util.composeBrahmi=function(k, g, b, j) {
    var f=j.length;
    if(f==0) {
        return""
    }
    var e=j.charCodeAt(0);
    ...
    ++c) {
        a=j.charCodeAt(c);
        d=branah.util.indexOf(k, a);
        if(branah.util.indexOf(b, e)!=-1&&e==a) {}
        if(branah.util.indexOf(b, e)!=-1&&d!=-1) {
            a=g[d]
        }
        if(e==39&&d!=-1) {
...
var tamil= {
    ...
    3001],
    compose:function(a) {
        return branah.util.composeBrahmi(this.vowel, this.modifier, this.consonant, a)
    }
}
...
var keyboard=null;
var local= {
    undo: [], redo: [], layout: null, fontSize: null
}

;
var layouts=[ {
    Id: "tamil99",
    Name: "Tamil99 Keyboard",
    Json: {
        "name":"Tamil",
        "dir":"ltr",
        "keys":[ {
...
,
{
    ...
    Json: {
        ...
        "dir":"ltr",
        "keys":[ {
            "i": "k0", "c": "0", "n": "ொ", "s": "ஒ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k1", "c": "0", "n": "1", "s": "!", "l": "", "t": "௧", "f": ""
        }
        ,
        {
            "i": "k2", "c": "0", "n": "2", "s": "@", "l": "", "t": "௨", "f": ""
        }
        ,
        {
            "i": "k3", "c": "0", "n": "3", "s": "#", "l": "", "t": "௩", "f": ""
        }
        ,
        {
            "i": "k4", "c": "0", "n": "4", "s": "$", "l": "", "t": "௪", "f": ""
        }
        ,
        {
            "i": "k5", "c": "0", "n": "5", "s": "%", "l": "", "t": "௫", "f": ""
        }
        ,
        {
            "i": "k6", "c": "0", "n": "6", "s": "த்ர", "l": "", "t": "௬", "f": ""
        }
        ,
        {
            "i": "k7", "c": "0", "n": "7", "s": "க்ஷ", "l": "", "t": "௭", "f": ""
        }
        ,
        {
            "i": "k8", "c": "0", "n": "8", "s": "ஷ்ர", "l": "", "t": "௮", "f": ""
        }
        ,
        {
            "i": "k9", "c": "0", "n": "9", "s": "(", "l": "", "t": "௯", "f": ""
        }
        ,
        {
            "i": "k10", "c": "0", "n": "0", "s": ")", "l": "", "t": "௰", "f": ""
        }
        ,
        {
            "i": "k11", "c": "0", "n": "-", "s": "ஃ", "l": "", "t": "௱", "f": ""
        }
        ,
        {
            "i": "k12", "c": "0", "n": "=", "s": "+", "l": "", "t": "௲", "f": ""
        ...
        ,
        {
            "i": "k13", "c": "0", "n": "ௌ", "s": "ஔ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k14", "c": "0", "n": "ை", "s": "ஐ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k15", "c": "0", "n": "ா", "s": "ஆ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k16", "c": "0", "n": "ீ", "s": "ஈ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k17", "c": "0", "n": "ூ", "s": "ஊ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k18", "c": "0", "n": "ப", "s": "ப", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k19", "c": "0", "n": "ஹ", "s": "ங", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k20", "c": "0", "n": "க", "s": "க", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k21", "c": "0", "n": "த", "s": "த", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k22", "c": "0", "n": "ஜ", "s": "ச", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k23", "c": "0", "n": "ட", "s": "ட", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k24", "c": "0", "n": "ஞ", "s": "ஞ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k25", "c": "0", "n": "\\", "s": "|", "l": "", "t": "", "f": ""
        ...
        ,
        {
            "i": "k26", "c": "0", "n": "ோ", "s": "ஓ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k27", "c": "0", "n": "ே", "s": "ஏ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k28", "c": "0", "n": "்", "s": "அ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k29", "c": "0", "n": "ி", "s": "இ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k30", "c": "0", "n": "ு", "s": "உ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k31", "c": "0", "n": "ப", "s": "ப", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k32", "c": "0", "n": "ர", "s": "ற", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k33", "c": "0", "n": "க", "s": "க", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k34", "c": "0", "n": "த", "s": "த", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k35", "c": "0", "n": "ச", "s": "ச", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k36", "c": "0", "n": "ட", "s": "ட", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k37", "c": "0", "n": "ெ", "s": "எ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k38", "c": "0", "n": "ஓ", "s": "௴", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k39", "c": "0", "n": "ம", "s": "ண", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k40", "c": "0", "n": "ந", "s": "ன", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k41", "c": "0", "n": "வ", "s": "ழ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k42", "c": "0", "n": "ல", "s": "ள", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k43", "c": "0", "n": "ஸ", "s": "ஷ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k44", "c": "0", "n": ",", "s": "ஷ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k45", "c": "0", "n": ".", "s": "ஸ்ரீ", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k46", "c": "0", "n": "ய", "s": "ய", "l": "", "t": "", "f": ""
        }
        ,
        {
            "i": "k47", "c": "0", "n": "\\", "s": "|", "l": "", "t": "", "f": ""
...
branah.initialize = function(kfield, editor){
    ...
    if(layouts.length == 1) {
        ...
        {
            layoutHtml.push((i == 0 ? "<p>" : ""), "<label", (i > 0 ? ' style="margin-left:2em"': ""), '><input id="kfield', layouts[i].Id, '" name="'+kfield+'type" type=radio', (local.layout == layouts[i].Id ? ' checked="checked"' : "") ,"> ", layouts[i].Name, "</label>", ((i + 1) == layouts.length ? "</p>" : ""));

            layoutsJson[i] = new branah.layout();
            layoutsJson[i].load(layouts[i].Json);
            
            if(local.layout == layouts[i].Id){
                keyboard.loadVirtualLayout(layouts[i].Json);
            }
        } 
        $("#"+kfield).append(layoutHtml.join(""));

        for(var i = 0; i < layouts.length; i++)
        {
            var scope = function(layoutId, layoutJson){
                $("#kfield" + layoutId).bind("click", function () {

                    if (local.layout != layoutId) {
                        keyboard.currentLayout = layoutJson;
                        keyboard.reset();
